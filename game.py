...
class Bolas:
    ...
    def main_loop(self):
        ...
        while game_over == False: 
            ...
            self.players[0].ball_collisioner(self.players[1])
...
class Ball:
    def __init__(self, x,y,radio,dy = 0, dx = 0):
        self.x = x
        self.y = y
        self.radio = radio
    ...
    def update(self,surface):
        ...
        if self.x >=  surface.get_width() or self.x <= self.radio:
            self.dx = -self.dx 

    def ball_collisioner(self,otra):
